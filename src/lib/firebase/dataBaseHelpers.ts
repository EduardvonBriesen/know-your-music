import {MAX_HISTORY_LENGTH, MAX_HISTORY_GENRE_LENGTH, WEIGHT_QUESTIONS_OVERALL,WEIGHT_SCORE_OVERALL, 
    WEIGHT_SCORE_HISTORY,WEIGHT_QUESTIONS_HISTORY} from "./dataBaseTypeDefinitions";
import type { UserData, Genre, LevelData, GenreData, GenreScores } from "./dataBaseTypeDefinitions";
 ...
 */
export function getUpdatedHistoryListOfGenres(listOfGenre: Genre[], index: number, newGenre: Genre){
...
export function getUpdatedScores(   oldGenreScores: GenreScores, 
                            genre: Genre,
